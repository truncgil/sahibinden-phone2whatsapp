...
function formatPhoneNumber(phoneNumber) {
    // Parantezler, boşluklar ve tire işaretlerini kaldır
    var cleaned = phoneNumber.replace(/\D/g, '');
    // Türkiye ülke kodunu ekle
    var formatted = '90' + cleaned;
    return formatted;
}

function button(href,x,y) {
    var button = '<a href="'+href+'" target="_blank" style="position:absolute;top:'+y+'px;right:'+x+'px;z-index:100;text-decoration:none;font-size:40px;" class="" download><span class="" >'
    +'<svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="52" viewBox="0 0 48 48">'
